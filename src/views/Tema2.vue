  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
        ...
        .col-12.col-md-6.posit
          PasosA.color-acento-contenido.mb-5(tipo="n")
            .row.align-items-center
              .col-md-4.mb-4.mb-md-0(data-aos="slide-right")
                figure.justify-center
                  img.img90(src='@/assets/curso/tema2/t2-21.svg', alt='Texto que describa la imagen')
            ...
            .row.align-items-center
              .col-md-4.mb-4.mb-md-0(data-aos="slide-right")
                figure.justify-center
                  img.img90(src='@/assets/curso/tema2/t2-23.svg', alt='Texto que describa la imagen')
              .col-md-8(data-aos="slide-left")
            ...
            .row.align-items-center
              .col-md-4.mb-4.mb-md-0(data-aos="slide-right")
                figure.justify-center
                  img.img90(src='@/assets/curso/tema2/t2-25.svg', alt='Texto que describa la imagen')
              .col-md-8(data-aos="slide-left")
        ...
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")
          .row(titulo="Integración con otras aplicaciones")
            .col-md-4.mb-4.mb-md-0
              figure.justify-center
                img.img200(src='@/assets/curso/tema2/t2-34.svg', alt='Texto que describa la imagen')
          ...
          .row(titulo="Información en tiempo real")
            .col-md-4.mb-4.mb-md-0
              figure.justify-center
                img.img200(src='@/assets/curso/tema2/t2-35.svg', alt='Texto que describa la imagen')
            .col-md-8.align-items-center
          ...
          .row(titulo="Son herramientas colaborativas")
            .col-md-4.mb-4.mb-md-0
              figure.justify-center
                img.img200(src='@/assets/curso/tema2/t2-36.svg', alt='Texto que describa la imagen')
            .col-md-8.align-items-center
          ...
          .row(titulo="Alcance de visualización")
            .col-md-4.mb-4.mb-md-0
              figure.justify-center
                img.img200(src='@/assets/curso/tema2/t2-37.svg', alt='Texto que describa la imagen')
            .col-md-8.align-items-center
    ...
    .row
      .col-12.col-md-4(data-aos="zoom-in-right")
        figure.justify-center
          img.img400(src='@/assets/curso/tema2/t2-38.svg', alt='Texto que describa la imagen')
